...
const SmallCard = ({ date, time }: SmallCardProps) => {
  return (
    <div className="w-full flex flex-row gap-5 items-center justify-center py-4">
      <div className=" px-6 py-1 text-md font-extralight text-center text-white  rounded-xl  bg-lime-800 flex flex-row gap-2 items-center justify-center border border-lime-700 md:text-xl">
