...
const GetvalueCard = ({ content, value }: GetvalueCardProps) => {
  return (
    <div className=" max-w-3xl rounded-xl overflow-hidden border text-white border-lime-800 bg-gradient-to-r from-black  to-green-900 p-5 flex flex-row justify-left items-center gap-3">
